    ...
    <div>
      ...
      <section className="container mx-auto py-8 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="/img/brand1.png" alt="Lentes de Contato Colorida Solflex Color Hype" width={300} height={200} className="w-full h-48 object-cover mb-4"/>
              ...
              <button className="mt-4 w-full cursor-pointer bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Adicionar ao Carrinho</button>
          </div>

          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="/img/brand2.png" alt="Óculos de Grau Atitude AT7133" width={300} height={200} className="w-full cursor-pointer h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="/img/brand3.png" alt="Lentes de Contato Incolor Acuvue Oasys" width={300} height={200} className="w-full cursor-pointer h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="/img/brand4.png" alt="Óculos de Grau Carolina Herrera CH0038 RHL" width={300} height={200} className="w-full cursor-pointer h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="/img/brand5.png" alt="Óculos de Grau Carolina Herrera CH0038 RHL" width={300} height={200} className="w-full cursor-pointer h-48 object-cover mb-4"/>
              <h3 className="text-lg font-medium">Óculos de Grau Carolina Herrera CH0038 RHL</h3>
              <p className="text-blue-600 font-bold mt-2">R$ 1.480,00</p>
              <button className="mt-4 w-full cursor-pointer bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Adicionar ao Carrinho</button>
          </div>
