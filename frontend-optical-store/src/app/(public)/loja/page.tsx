    ...
    <div>
      ...
      <section className="container mx-auto py-8 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="https://via.placeholder.com/300x200" alt="Lentes de Contato Colorida Solflex Color Hype" width={300} height={200} className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="https://via.placeholder.com/300x200" alt="Óculos de Grau Atitude AT7133" width={300} height={200} className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="https://via.placeholder.com/300x200" alt="Lentes de Contato Incolor Acuvue Oasys" width={300} height={200} className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <Image src="https://via.placeholder.com/300x200" alt="Óculos de Grau Carolina Herrera CH0038 RHL" width={300} height={200} className="w-full h-48 object-cover mb-4"/>
      ...
      <footer className="bg-gray-100 py-6 mt-12">
        <div className="container mx-auto px-6 text-center text-sm text-gray-600">
          <p>Telefone: (11) 3181-6030 | WhatsApp: (11) 99677-5541</p>
          <p>Email: contato@olhosdobem.com.br</p>
          <p className="mt-2">&copy; 2025 Ótica Olhos do Bem. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
