      ...
      <section className="container mx-auto py-8 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <img src="https://via.placeholder.com/300x200" alt="Lentes de Contato Colorida Solflex Color Hype" className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <img src="https://via.placeholder.com/300x200" alt="Óculos de Grau Atitude AT7133" className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <img src="https://via.placeholder.com/300x200" alt="Lentes de Contato Incolor Acuvue Oasys" className="w-full h-48 object-cover mb-4"/>
          ...
          <div className="border rounded-lg p-4 shadow hover:shadow-lg transition">
            <img src="https://via.placeholder.com/300x200" alt="Óculos de Grau Carolina Herrera CH0038 RHL" className="w-full h-48 object-cover mb-4"/>
